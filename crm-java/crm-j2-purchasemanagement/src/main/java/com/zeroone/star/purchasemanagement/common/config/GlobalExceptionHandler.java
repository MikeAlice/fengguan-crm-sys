...
public class GlobalExceptionHandler {
     ...
     * @return 返回异常信息回显数据
     */
    @ExceptionHandler(value = PurchaseManagementException.class)
    public JsonVO<Void> orgStructureExceptionHandler(PurchaseManagementException e) {
        return JsonVO.create(null, PurchaseManagementException.CODE, e.getMessage());
    }
