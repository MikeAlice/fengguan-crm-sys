...
*/
#ifndef _UPDATEPAYPLAN_DTO_
#define _UPDATEPAYPLAN_DTO_
...
class updatePayPlanDTO : public oatpp::DTO
{
	...
	// 已回款金额
	API_DTO_FIELD_DEFAULT(Float32, backAmount, ZH_WORDS_GETTER("collectionplan.field.backAmount"));
	...
	// 计划回款金额
	API_DTO_FIELD_DEFAULT(Float32, planBackAmount, ZH_WORDS_GETTER("collectionplan.field.planBackAmount"));
