...
*/
#ifndef _CAPITAL_RECORD_DTO_
#define _CAPITAL_RECORD_DTO_
#include "../../GlobalInclude.h"

#include OATPP_CODEGEN_BEGIN(DTO)

/**
 * FinCapitalRecord传输对象
*/
class CapitalRecordDTO : public oatpp::DTO
{
	DTO_INIT(CapitalRecordDTO, DTO);
	// record_id 单号
