...
#ifndef _SALESCONTRACTDTO_H_
#define _SALESCONTRACTDTO_H_
...
//定义销售合同对象
class SalesContractDTO : public oatpp::DTO
{
	DTO_INIT(SalesContractDTO, DTO);
	// 销售机会id
	API_DTO_FIELD_DEFAULT(Int32, id, ZH_WORDS_GETTER("SalesOpportunityInfo.field.id"));
	//合同ID
...
//定义一个用户信息分页传输对象
class SalesContractPageDTO : public PageDTO<SalesContractDTO::Wrapper>
{
	DTO_INIT(SalesContractPageDTO, PageDTO<SalesContractDTO::Wrapper>);
};
