...
*/
#ifndef _CSTFIELDEXTMAPPER_H_
#define _CSTFIELDEXTMAPPER_H_

#include "Mapper.h"
#include "domain/do/CstFieldExt/CstFieldExtDO.h"


class CstFieldExtMapper : public Mapper<CstFieldExtDO>
{
public:
