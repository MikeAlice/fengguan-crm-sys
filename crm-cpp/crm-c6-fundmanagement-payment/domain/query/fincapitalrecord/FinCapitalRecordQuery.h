...
/*
 ...
 @Author: chaoneng
 @Date: 2023/10/21
 @FileName: FinCapitalRecordQuery
 @version: 1.2
...
*/
#ifndef _FIN_CAPITAL_RECORD_QUERY_
#define _FIN_CAPITAL_RECORD_QUERY_
 ...
 * 资金注入抽取查询对象
 */
class FinCapitalRecordQuery : public PageQuery
{
	DTO_INIT(FinCapitalRecordQuery, PageQuery);
	// record_id 单号
	API_DTO_FIELD_DEFAULT(UInt64, record_id, ZH_WORDS_GETTER("payment.field.record_id"));
	// type_id 支出类型
