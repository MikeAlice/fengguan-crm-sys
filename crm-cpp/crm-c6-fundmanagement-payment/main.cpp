...
#ifdef USE_NACOS
	// Nacos配置参数
	std::string nacosAddr = "154.8.141.38:8848";
	// std::string nacosAddr = "192.168.10.128:8848";
	// std::string nacosNs = "72da0a31-59d8-43eb-b78c-431ebdc223d3";
	std::string nacosNs = "crm-dev";
