...
class LinkmanNameDTO : public oatpp::DTO
{
	...
	API_DTO_FIELD_DEFAULT(UInt64, linkman_id, ZH_WORDS_GETTER("supplier-linkman.query-linkman-name.field.linkman-id"));
	API_DTO_FIELD_DEFAULT(String, name, ZH_WORDS_GETTER("supplier-linkman.query-linkman-name.field.name"));
public:
	/*LinkmanNameDTO()
	{
		linkman_id = 666;
