...
class ModifyTraceDTO : public oatpp::DTO
{
	DTO_INIT(ModifyTraceDTO, DTO);
		//跟踪记录id
		API_DTO_FIELD_DEFAULT(UInt64, trace_id, ZH_WORDS_GETTER("trace.field.TR_id"))
		//客户名称id
		API_DTO_FIELD_DEFAULT(UInt64, customer_id, ZH_WORDS_GETTER("trace.field.AC_id"))
		//联系客户人id
		API_DTO_FIELD_DEFAULT(UInt64, linkman_id, ZH_WORDS_GETTER("trace.field.CC_id"))
		//沟通方式id
