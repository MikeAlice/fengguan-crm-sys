 ...
 * 客户详情传输对象
 */
class DetailsCustomerDTO : public BaseCustomerDTO
{
	DTO_INIT(DetailsCustomerDTO, BaseCustomerDTO);
	//客户id
 ...
 * 客户详情分页传输对象
 */
class DetailsCustomerPageDTO : public PageDTO<DetailsCustomerDTO::Wrapper>
{
	DTO_INIT(DetailsCustomerPageDTO, PageDTO<DetailsCustomerDTO::Wrapper>);
};
